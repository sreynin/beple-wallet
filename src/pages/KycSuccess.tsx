  ...
  return (
    <div className="flex flex-col h-[calc(100%-44px)] bg-white animate-fade-in">
      <div className="flex-1 flex flex-col items-center justify-center px-8">
        ...
        <p className="text-sm text-text-gray text-center leading-relaxed">{t('kyc_success_msg')}</p>

        <div className="w-full mt-8 bg-gray-50 rounded-2xl p-5">
          <div className="flex items-center justify-between">
            <span className="text-sm text-text-gray">{t('kyc_success_grade')}</span>
            <span className="text-sm font-semibold text-green-600">Minimal-KYC</span>
          </div>
          ...
          <p className="mt-3 pt-3 border-t border-border text-xs text-text-gray leading-relaxed">
            {t('kyc_success_upgrade_hint')}
          </p>
        </div>
      </div>
